...
<body>
    ...
    <section id="about">
        <div class="about-row">
            ...
            <div class="info-col">
                ...
                <h2 class="heading">We Provide Simple, Yet End-To-End Book Archiving.</h2>
                <p class="sub-para">At our company, we specialize in creating stunning websites that are not only aesthetically pleasing, but also user-friendly and optimized for search engines. Our web design and development team has the expertise and creativity to bring your vision to life and help your online presence stand out.</p>
                ...
                <div class="useful-links">
                    ...
                    <div class="filter-info" id="Btn1Filter">
                        <p style="margin-bottom: 1.5rem;">Our team specializes in two main areas: Providing ui design and web development. Working with clients to preserve literary legacies and create standout websites. Our team is dedicated to providing exceptional service and customized solutions.</p>
                        <div class="icon-list">
                    ...
                    <div class="filter-info" id="Btn2Filter">
                        <p style="margin-bottom: 1.5rem;">Our mission is to support the company's in delivering affordable, high-quality IT products and services with efficient, professional customer service and support. We're committed to upholding the company's dedication to outstanding customer satisfaction. We hope to not only fulfill our responsibilities as an intern, but also make a positive impact on the company's overall success.</p>
                        <div class="icon-list">
                    ...
                    <div class="filter-info" id="Btn3Filter">
                        <p style="margin-bottom: 1.5rem;">Our goal is to contribute to the company's vision of revolutionizing the way technology works by creating innovative and user-friendly solutions that make our clients' lives easier. By aligning my work with the company's vision, We hope to not only meet the needs of our clients, but also contribute to the company's success in driving positive change in the industry.</p>
                        <div class="icon-list">
    ...
    <!-- NEW FEATURES -->
        <div class="container-fluid" id="faqs" style="margin-bottom: 8.5rem; width: 125vh">
            ...
            <div class="accordion">
                <div class="icon"></div>
                <h5 style="color: #d4d1cb;">What is Web-based Book Archiving?</h5>
            </div>
            <div class="panel">
                <p>Web-based Book Archiving is an online platform for archiving and organizing books. It allows users to easily create digital copies of their books and keep track of their collection online. Please note that all content and materials provided on this website, including but not limited to the books archived on this platform, are the property of Hoopoelink Company and are protected by international copyright laws. Users may not reproduce, distribute, or modify any content on this website without the express written permission of Hoopoelink Company.</p>
            </div>

            <div class="accordion">
                <div class="icon"></div>
                <h5 style="color: #d4d1cb;">Is my personal information secure on Web-based Book Archiving?</h5>
            </div>
            <div class="panel">
                <p>Yes, we take the privacy and security of our users very seriously. We use industry-standard encryption and security measures to protect your personal information and data.</p>
            </div>

            <div class="accordion">
                <div class="icon"></div>
                <h5 style="color: #d4d1cb;">How can I contact customer support?</h5>
            </div>
            <div class="panel">
                <p>You can contact our customer support team by emailing [info@hoopoelink.com]. We are available to help with any questions or issues you may have.</p>
            </div>

            <div class="accordion">
                <div class="icon"></div>
                <h5 style="color: #d4d1cb;">How often are new books added to the website?</h5>
            </div>
            <div class="panel">
                <p>We add new books to our website on a regular basis. Our team is constantly working to expand our collection and provide our users with a wide range of books to choose from.</p>
            </div>
        </div>
    <!-- ENDS HERE! -->
    ...
    <section class="home" id="team">
        <div id="team" class="padding" style="background-color: #131516; padding: 1%; padding-top: 5rem; padding-bottom: 2.5rem;">
            ...
            <div class="team-row" style="display: flex;">
                ...
                <div class="img-box">
                    <div class="img">
                        <img src="img/team/hotohot_id.png" alt="">
                        <div class="icons">
                            <a href="#"><i class="fa-brands fa-facebook"></i></a>
                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                            <a href="#"><i class="fa-brands fa-twitter"></i></a>
                ...
                <div class="img-box">
                    ...
                    <div class="img-info">
                        <h3>Fertony Jr.</h3>
                        <p>Head-Developer / Project Manager</p>
                    </div>
                </div>                
                ...
                <div class="img-box">
                    <div class="img">
                        <img src="img/team/ordaniza_id.png" alt="">
                        <div class="icons">
                            <a href="#"><i class="fa-brands fa-facebook"></i></a>
                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                            <a href="#"><i class="fa-brands fa-twitter"></i></a>
            ...
            <div class="team-row" style="display: flex;">
                ...
                <div class="img-box">
                    <div class="img">
                        <img src="img/team/acosta_id.png" alt="">
                        <div class="icons">
                            <a href="#"><i class="fa-brands fa-facebook"></i></a>
                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                            <a href="#"><i class="fa-brands fa-twitter"></i></a>
                ...
                <div class="img-box">
                    <div class="img">
                        <img src="img/team/banias_id.png" alt="">
                        <div class="icons">
                            <a href="#"><i class="fa-brands fa-facebook"></i></a>
                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                            <a href="#"><i class="fa-brands fa-twitter"></i></a>
